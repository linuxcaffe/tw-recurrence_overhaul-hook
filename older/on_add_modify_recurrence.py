...
debug_log("="*60)
debug_log("Hook starting - reading stdin")
...
HOOK_TYPE = "ADD" if IS_ON_ADD else "MODIFY"
...
def main():
    ...
    global lines  # Use the lines already read at module level
    
    debug_log("Main function started")
    debug_log(f"Processing {len(lines)} lines")
